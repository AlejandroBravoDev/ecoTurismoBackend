...
class FavoritosControllerTest extends TestCase
{
    ...
    public function test_anadir_favorito_exitosamente()
    {
        ...
        $response = $this->postJson('/api/favoritos', ['lugar_id' => $lugar->id]);

        $response->assertStatus(201)
                 ->assertJsonStructure([
                     'message',
                     'favorito' => ['id', 'usuario_id', 'lugar_id']
                 ])
                 ->assertJsonFragment([
    ...
    public function test_error_si_no_se_envia_lugar_ni_hospedaje()
    {
        ...
        $response = $this->postJson('/api/favoritos', []);
    ...
    public function test_eliminar_favorito_exitosamente()
    {
        ...
        $response = $this->deleteJson('/api/favoritos/' . $favorito->id);
